...
import projects.SimuladorRSSF.nodes.tools.Bateria;
import projects.SimuladorRSSF.nodes.tools.Rotas;
...
public class Sensor extends Node {	
	...
	//gerador de número aleátórios responsável por gerar o tempo de espera para
	...
	public void tratarMensagemRota(MensagemRota msg){
		if(isActive){
			//verifica se o Sensor já recebeu está mensagem de rota
	...
	/*
	 * Neste método é verifica os requisitos para o metodo ser considerado ativo:
	 * Ter Bateria
	 ...
	 * do Sensor
	 * 
	 * Há a realização do consumo de energia quando o Sensor está ativo
	 * Há a realização da contagem de tempo para obter uma nova rota
	 */
	@Override
	public void preStep() {
		if(isActive){
