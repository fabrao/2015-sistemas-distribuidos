package projects.SimuladorRSSF.nodes.nodeImplementations;

import java.awt.Color;
import java.awt.Graphics;

import projects.SimuladorRSSF.Configuracoes;
import projects.SimuladorRSSF.Estatisticas;
import projects.SimuladorRSSF.nodes.messages.MensagemDados;
import projects.SimuladorRSSF.nodes.messages.MensagemRota;
import projects.SimuladorRSSF.nodes.timers.RoundEnvio;
...
public class Sink extends Node{
	...
	private void tratarMensagemDados(MensagemDados msg) {
		...
		Tools.appendToOutput("nº: " + msg.getIdOrigem() + "   Temp: " + msg.getTemperatura() + "°C   UR: " +msg.getUmidade() + "%\n");
	}
	
	//metódo que permite a aquisição dos dados pelo usuário a partir da interface
	@NodePopupMethod(menuText = "Dados da Simulação")
	public void dadosSimulacao(){
		...
		Tools.appendToOutput("A Taxa de Mensagens Recebidas é "+ Estatisticas.txMsgs() + "\n");
		Tools.appendToOutput("A porcentagem de Sensores Ativos é " + Estatisticas.pcSensores() + "\n");
		Tools.appendToOutput("A Taxa de Energia Consumida por Mensagens Recebidas é " + Estatisticas.txEnergia() + "\n");
	}
