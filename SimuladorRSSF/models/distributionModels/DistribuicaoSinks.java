package projects.SimuladorRSSF.models.distributionModels;

import sinalgo.configuration.Configuration;
import sinalgo.models.DistributionModel;
import sinalgo.nodes.Position;

//classe que implementa a distribuição dos sinks para o problema a ser resolvido
public class DistribuicaoSinks extends DistributionModel{
	
	int numeroSink=0;
	
	//este método implementa a distribuição dos sinks deste projeto, de acordo com o determinado pelo cenário
